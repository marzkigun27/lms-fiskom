...
class FortifyServiceProvider extends ServiceProvider
{
            ...
            function () {
                return new class implements LoginResponseContract
                {
                    public function toResponse($request)
                    {
                        ...
                        return redirect()->intended('/praktikan');
                    }
                };
            }
        );
    ...
    private function configureActions(): void
    {
        ...
        Fortify::authenticateUsing(function (Request $request) {
            ...
            if ($user &&
                ...
                $loginType = $request->input('login_type', 'praktikan');

                if ($loginType === 'asisten' && $user->user_type !== 'assistant') {
                    return null;
                }

                if ($loginType === 'praktikan' && $user->user_type !== 'participant') {
                    return null;
                }
    ...
    private function configureViews(): void
    {
        ...
        Fortify::registerView(fn (Request $request) => Inertia::render('welcome', [
            'showLoginModal' => true,
